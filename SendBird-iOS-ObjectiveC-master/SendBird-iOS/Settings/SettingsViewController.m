...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        ...
        case 2: {
            SettingsSectionTableViewCell *viewCell = (SettingsSectionTableViewCell *)[tableView dequeueReusableCellWithIdentifier:@"SettingsSectionTableViewCell"];
            viewCell.sectionLabel.text = @"NOTIFICATIONS";
        ...
        case 11: {
            ...
            break;
        case 12: {
            SettingsVersionTableViewCell *viewCell = (SettingsVersionTableViewCell *)[tableView dequeueReusableCellWithIdentifier:@"SettingsVersionTableViewCell"];          viewCell.versionLabel.text = @"";
        }
        case 13: {
            ...
            if (path != nil) {
                ...
                NSString *version = @"";
                //[NSString stringWithFormat:@"Sample UI v%@ / SDK v%@", sampleUIVersion, [SBDMain getSDKVersion]];
